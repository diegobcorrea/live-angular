# AngularJS-amqApp
Simple AngularJS amqApp to kick start your new project with SASS support and Gulp watch/build tasks
...
## Download
```bash
bower install angularjs-amqApp
```

or

```bash
git clone https://github.com/jbutko/AngularJS-amqApp.git
```
